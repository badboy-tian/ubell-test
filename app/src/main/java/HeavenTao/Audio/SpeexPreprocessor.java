...
public class SpeexPreprocessor//Speex预处理器类
{
    ...
    //对一帧音频输入数据进行Speex预处理
    public int Preprocess( short clAudioInput[], Integer clVoiceActivityStatus )
    {
    ...
    private native int SpeexPreprocessPreprocess( Long clSpeexPreprocessState, short clAudioInput[], Integer clVoiceActivityStatus );
